...
<div style="max-width: 76%; margin-left: 13%" class="card promoting-card">
  ...
  <div class="card-body">
    ...
    " class="btn btn-sm"><i style="color: #fff" class="fas fa-trash-alt fa-lg text-muted float-right p-1 my-1" data-toggle="tooltip" data-placement="top" title="delete this complain"></i></button>
    </div>
