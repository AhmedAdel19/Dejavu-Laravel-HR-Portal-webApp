        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                        ...
                        <form method="POST" action="{{route('employee_balance.search')}}">
                            @csrf
...
<table class="table table-striped table-dark">
    <thead style="background-color: #302523; color:cornsilk">
      <tr>
        ...
        <th scope="col">Employee Balance</th>
  ...
  <?php $c =1 ?>
    ...
    @foreach($all_users as $user)
      <tr>
        ...
        <td>{{$user->title}}</td>
        <td><a href="{{url('employees_balance/' . $user->id) }}" class="btn btn-primary float-left mr-3"> Show Balance</a> </td>
      </tr>
      <?php $c++ ?>
    @endforeach  
    </tbody>
