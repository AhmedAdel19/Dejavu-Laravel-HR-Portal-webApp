...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div style="color:cornsilk" class="card-header d-flex justify-content-center bg-dark">{{ __('Add new General Notification') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{url('generaklNotifications')}}" enctype="multipart/form-data">
                        @csrf
